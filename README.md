...
- **公司信息模块**：在个股详情内新增，按板块展示：① 十大控股股东与实际控制人；② 分红数据（每年分红比率、每股分红、近5年平均分红额度）；③ 财务绩效指标（关键 / 盈利 / 风险三组，含年度 / 半年 / 季度及同比，点击任一指标以「柱状图(数值)+折线图(同比增长率)」双轴展示，可切换 年度 / 半年 / 季度 粒度）；④ 高管增减持明细；⑤ 公司简介。
